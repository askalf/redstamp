...
Scored 7 firewall(s) through the same stdin/stdout pipe (see [protocol.md](protocol.md)). Regenerate: `node arena/run.mjs --corpus external-corpus.json`.

| firewall | offline | deterministic | recall (block) | recall (+gate) | precision | under-gate | median µs |
|---|---|---|---|---|---|---|---|
| warden | yes | yes | 100.0% | 100.0% | **100%** | 1/8 | 70 |
...
| mcp-firewall (inbound pipeline) | yes | yes | 8.3% | 100.0% | 95.8% | 0/8 | 47 |
